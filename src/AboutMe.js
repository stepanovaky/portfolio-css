    ...
    <section id="aboutme" className="aboutme">
      <div className="middle">
        ...
        <p>
          ...
          program at Thinkful. I enjoy coding because each project is a
          challenge and a puzzle for me.
        </p>
        <br />
        <p>
          I am looking forward to working with a team of developers and honing
          my technical skills even further.
        </p>
        <br />
        <p>
        ...
        <footer>
          <address>
            ...
            <a href="mailto:stepanovaky@gmail.com" target="_blank">
              <p>
                <GrMail />
              </p>
            </a>
